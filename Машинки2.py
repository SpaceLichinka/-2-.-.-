def prosmotr():
    ...
    if (menu[0] == '1' or menu[0] == '2' or menu[0] == '3' or menu[0] == '4' or menu[0] == '5' or menu[0] == '6' or\
        ...
        if x not in range(1,len(S)+1):
            ...
            print('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n')
            prosmotr() # Вызов функции ПРОСМОТР(ИЗМЕНИТЬ)
        else:
            print('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n')
            stroka = []
            split = ''
        ...
        f2 = 0
        dobav() # Вызов функции ДОБАВИТЬ
            
    elif (menu == '-'):                
        f3 = 0
        delet() # Вызов функции УДАЛИТЬ
    elif (menu == 'поиск'):
        poisk() # Вызов функции ПОИСК
    else:
